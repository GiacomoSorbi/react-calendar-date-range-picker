...
var DateRange = (function (_Component) {
  ...
  _createClass(DateRange, [{
    ...
    value: function componentDidMount() {
      ...
      if (onInit) onInit(this.state.range);
    }
  }, {
    key: 'orderRange',
    ...
    key: 'setRange',
    value: function setRange(oldRange, source, triggerChange) {
      var onChange = this.props.onChange;

      var range = this.orderRange(oldRange);
    ...
    value: function render() {
      ...
      var _props$showYearAlone = _props.showYearAlone;
      var showYearAlone = _props$showYearAlone === undefined ? true : _props$showYearAlone;
